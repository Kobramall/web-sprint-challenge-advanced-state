...
import { MOVE_CLOCKWISE, RESET_FORM, MOVE_COUNTERCLOCKWISE, SET_QUIZ_INTO_STATE, SET_SELECTED_ANSWER, SET_INFO_MESSAGE, INPUT_CHANGE } from './action-types'
  ...
  switch(action.type){
    ...
    case CHANGE_INPUT:
      if(action.payload.id === "newQuestion"){
           return{...state, newQuestion: action.payload.str}
      }
