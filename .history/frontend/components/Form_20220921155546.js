...
console.log(props.newTrueAnswer.length)
...
const onChange = evt => {
  ...
  return (
    <form id="form" onSubmit={onSubmit}>
      ...
      <button id="submitNewQuizBtn" disabled={props.newQuestion.length < 1 || props.newTrueAnswer.length < 1 || props.newFalseAnswer.length < 1 ? true : false}>Submit new quiz</button>
    </form>
  )
}
