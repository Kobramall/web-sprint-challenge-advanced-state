...
function Form(props) {
 ...
 console.log(disable(props.newFalseAnswer), disable(props.newTrueAnswer))
...
const onChange = evt => {
  ...
  return (
    <form id="form" onSubmit={onSubmit}>
      ...
      <button id="submitNewQuizBtn" disabled={disable(newFalseAnswer) < 1 || disable(newTrueAnswer) < 1 || disable(newQuestion) < 1 ? true : false}>Submit new quiz</button>
    </form>
  )
}
