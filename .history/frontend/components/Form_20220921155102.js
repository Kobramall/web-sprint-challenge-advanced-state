...
const ql = props.newQuestion.length
const tl = props.newTrueAnswer.length
const fl = props.newFalseAnswer.length

console.log(ql, tl, fl)
...
const onChange = evt => {
  ...
  return (
    <form id="form" onSubmit={onSubmit}>
      ...
      <button id="submitNewQuizBtn" disabled={ql < 1 || props.newTrueAnswer.length < 1 || props.newFalseAnswer.length < 1 ? true : false}>Submit new quiz</button>
    </form>
  )
}
