...
import { postAnswer, change, setMessage, postQuiz  } from '../state/action-creators'
...
export default connect(mapStateToProps, { postAnswer, change, setMessage, postQuiz })(Form)
