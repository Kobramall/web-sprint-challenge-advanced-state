...
const onChange = evt => {
  ...
  return (
    <form id="form" onSubmit={onSubmit}>
      ...
      <button id="submitNewQuizBtn" disabled={props.newQuestion.length > 1 && props.newTrueAnswer.length >1 && props.newFalseAnswer.length > 1 ? false : true}>Submit new quiz</button>
    </form>
  )
}
