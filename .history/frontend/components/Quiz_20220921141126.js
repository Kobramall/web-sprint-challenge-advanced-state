...
import { fetchQuiz, selectAnswer, setMessage, inputChange} from '../state/action-creators'
    ...
    <div id="wrapper">
      {
        ...
        props.isFetching === false ? (
          <>
            <h2 onChange={props.fetchQuiz()}>{props.question}</h2>
...
export default connect(mapStateToProps, {fetchQuiz, selectAnswer, setMessage, inputChange})(Quiz);